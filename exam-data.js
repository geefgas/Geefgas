...
const TAXI_EXAMEN_2 = {
  ...
  questions: [
    ...
    q(16,"Werk- vs privétijd","Waarom is onderscheid tussen werk en privé belangrijk?",["Omdat klanten dat leuk vinden","Omdat registratie/handhaving daarop kan controleren","Omdat je dan sneller rijdt"],1),
    ...
    q(19,"Dienststop","Wat is verstandig bij einde dienst?",["Alles open laten staan","Dienst correct afsluiten volgens procedure","BCT in de auto gooien"],1),
    q(20,"Dienst","Wat is juist bij onderbrekingen (pauze) in een dienst?",["Altijd door als werk registreren","Registreren zoals het werkelijk is volgens regels/procedure","Hele dag op ‘pauze’ zetten"],1),

    q(21,"Bewijslast","Waarom moet registratie controleerbaar zijn?",["Voor social media","Omdat handhaving feiten nodig heeft","Omdat klanten dat eisen"],1),
    q(22,"Bewijslast","Wat is het grootste probleem met ‘achteraf invullen uit je hoofd’?",["Het kost tijd","Het is foutgevoelig en vaak niet toegestaan","Het werkt niet op iPhone"],1),
...
const TAXI_EXAMEN_5 = {
  id: "taxi-examen-5",
  title: "Taxi Examen 5 – Klachten & professionaliteit (40 vragen)",
  category: "Taxi",
  durationMinutes: 30,
  passMinCorrect: 32,
  questions: [
...
const TAXI_EXAMEN_7 = {
  id: "taxi-examen-7",
  title: "Taxi Examen 7 – Ondernemen & kwaliteit (40 vragen)",
  category: "Taxi",
  durationMinutes: 30,
  passMinCorrect: 32,
  questions: [
...
const TAXI_EXAMEN_8 = {
  id: "taxi-examen-8",
  title: "Taxi Examen 8 – Ethiek & grenzen (40 vragen)",
  category: "Taxi",
  durationMinutes: 30,
  passMinCorrect: 32,
  questions: [
...
const TAXI_EXAMEN_9 = {
  id: "taxi-examen-9",
  title: "Taxi Examen 9 – Bijzondere doelgroepen (40 vragen)",
  category: "Taxi",
  durationMinutes: 30,
  passMinCorrect: 32,
  questions: [
  ...
  /* =========================
   TAXI EXAMEN 10
   Onderwerp: Calamiteiten & noodsituaties
   ========================= */
...
const TAXI_EXAMEN_12 = {
  id: "taxi-examen-12",
  title: "Taxi Examen 12 – Tarieven, meter, wachttijd & factuur (40 vragen)",
  category: "Taxi",
  durationMinutes: 30,
  passMinCorrect: 32,
  questions: [
...
const TAXI_EXAMEN_13 = {
  id: "taxi-examen-13",
  title: "Taxi Examen 13 – Veiligheid, PAMAN & noodsituaties (40 vragen)",
  category: "Taxi",
  durationMinutes: 30,
  passMinCorrect: 32,
  questions: [
...
const TAXI_EXAMEN_14 = {
  id: "taxi-examen-14",
  title: "Taxi Examen 14 – Wetgeving, ILT & documenten (40 vragen)",
  category: "Taxi",
  durationMinutes: 30,
  passMinCorrect: 32,
  questions: [
...
const TAXI_EXAMEN_15 = {
  id: "taxi-examen-15",
  title: "Taxi Examen 15 – Klantservice & afhandeling (40 vragen)",
  category: "Taxi",
  durationMinutes: 30,
  passMinCorrect: 32,
  questions: [
